...
async function testAIDataFormat() {
  ...
  const templateStart = `你是一位专业的大学学业导师，特别熟悉上海工程技术大学的GPA计算规则和课程安排。
...
- 只有成绩通过的课程才计入总学分。
- 绩点换算：90-100分=4.0, 85-89分=3.7, 82-84分=3.7, 78-81分=3.0, 75-77分=2.7, 72-74分=2.3, 68-71分=2.0, 66-67分=1.7, 64-65分=1.5, 60-63分=1.0, 60分以下=0。
...
`;
  ...
  const prompt = templateStart + formattedData + templateEnd;
